...
- **Integration with Lc0:** During selection, moves are prioritized using a combination of Lc0 scores and UCB1 values, with 0.7 weight for Lc0 evaluation and 0.3 for UCB1 evaluation 
